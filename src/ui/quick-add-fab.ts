		...
		return [
			{
				...
				items: [
					...
					},
					{
						...
						onClick: () => exec("atlas:atlas-voice-capture"),
					},
					{
						icon: "📓",
						label: "Daily log",
					...
					},
					{
						...
						onClick: () => exec("atlas:atlas-vision"),
					},
				],
			},
			{
				...
				items: [
					...
					},
					{
						...
						onClick: () => exec("atlas:atlas-create-course"),
					},
					{
						icon: "🔔",
						label: "Reminder",
						description: "Lembrete com data/hora + notification",
						onClick: () => exec("atlas:atlas-create-reminder"),
					},
					{
						icon: "📧",
						label: "Email",
						description: "Compose email avulso (SMTP)",
						onClick: () => exec("atlas:atlas-compose-email"),
					},
					{
						icon: "🤝",
						label: "1:1 (GROW)",
						description: "Iniciar sessão com pessoa",
						onClick: () => exec("atlas:atlas-prepare-1on1"),
					},
					{
						icon: "🕰️",
						label: "Time capsule",
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						onClick: () => exec("atlas:atlas-reasoning"),
					},
					{
						icon: "⚰️",
						label: "Pre-mortem",
						description: "Análise de risco de iniciativa",
						onClick: () => exec("atlas:atlas-premortem-oracle"),
					},
				],
			},
		];
