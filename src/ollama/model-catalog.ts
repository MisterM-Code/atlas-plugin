...
export const CATALOG: CatalogModel[] = [
	...
	// ─── REASONING (DeepSeek-R1 — Sprint 25) ───
	{
		tag: "deepseek-r1:7b",
		name: "DeepSeek R1 — 7B",
		category: "balanced",
		...
		supportsTools: false,
		ptBrQuality: 4,
		description: "State-of-art reasoning compacto. Use Pre-mortem, RCA, decisões complexas.",
	},
	{
		tag: "deepseek-r1:14b",
		...
		ptBrQuality: 4,
		recommended: true,
		description: "Reasoning premium. Rivaliza GPT-4o em raciocínio, 100% local.",
	},

	// ─── ALTERNATIVAS GERAÇÃO ───
	{
		tag: "mistral:7b",
		name: "Mistral — 7B",
		category: "balanced",
		...
		supportsTools: true,
		ptBrQuality: 4,
		description: "Mistral AI. Alternativa ao qwen com tom mais natural.",
	},
	{
		tag: "mixtral:8x7b",
		...
		supportsTools: true,
		ptBrQuality: 5,
		description: "MoE: 47B params total, ativa só 13B. Premium quality. Requer 32+ GB RAM.",
	},
	{
		tag: "codestral:22b",
		name: "Codestral — 22B",
		...
		supportsTools: true,
		ptBrQuality: 3,
		description: "Specialist em código (80+ linguagens). Para perfil TI/Eng — Architecture, ADR, code review.",
	},
	{
		tag: "granite3.0-dense:8b",
		name: "Granite 3.0 — 8B",
		category: "balanced",
		kind: "generation",
		ramGB: 5.5,
		...
		supportsTools: true,
		ptBrQuality: 3,
		description: "IBM enterprise model. Ideal para Compliance/Jurídico (BACEN, LGPD).",
	},
	{
		...
		supportsTools: true,
		ptBrQuality: 5,
		description: "Top tier 2025. Apenas máquinas 40+ GB RAM. Qualidade máxima.",
	},
	{
		tag: "aya-expanse:8b",
		name: "Aya Expanse — 8B",
		...
		supportsTools: false,
		ptBrQuality: 5,
		description: "Cohere multilingual (23 línguas). PT-BR forte. Boa pra coach internacional.",
	},
];
